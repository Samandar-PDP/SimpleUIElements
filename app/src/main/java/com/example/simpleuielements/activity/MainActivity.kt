...
class MainActivity : AppCompatActivity() {
    ...
    private val languages = arrayOf("Java", "Kotlin", "Dart", "JavaScript", "C++", "C", "Python")
    ...
    private fun customCheckBox() {
        val chBoxJava: AppCompatCheckBox = findViewById(R.id.chBoxJava)
        val chBoxKotlin: AppCompatCheckBox = findViewById(R.id.chBoxKotlin)
        val btnCheckClick: AppCompatButton = findViewById(R.id.btnChClick)
